...
export const Stat: Record<string, StatEntry> = {
...
export const BestScoreStatByGameSize: Record<GameSizeValue, StatEntry> = {
  [GameSize.SMALL]: Stat.BEST_SCORE_EASY,
  [GameSize.MEDIUM]: Stat.BEST_SCORE_MEDIUM,
  [GameSize.LARGE]: Stat.BEST_SCORE_HARD,
};

export const TotalScoreStatByGameSize: Record<GameSizeValue, StatEntry> = {
